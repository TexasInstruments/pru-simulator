...
CURRENT_BASE_A = 10
DEFAULT_CONTROL_PERIOD_IEP_TICKS = 3000
MAX_VOLTAGE_MAGNITUDE_Q24 = 9686330
MAX_VOLTAGE_MAGNITUDE_SQUARED_Q24 = 5592405
MAX_VOLTAGE_MAGNITUDE_PU = 0.5773502691896258
STATUS_DISABLED = 1
STATUS_SATURATED = 2
STATUS_DEADLINE_MISS = 4
STATUS_INVALID_CONFIG = 8
...
CONTROL_CONTROL_PERIOD_IEP_TICKS_OFF = 0x24
CONTROL_PERIOD_IEP_TICKS_OFF = CONTROL_CONTROL_PERIOD_IEP_TICKS_OFF
...
PWM_OUT_STATUS_OFF = 0x28
PWM_OUT_SPEED_CMD_Q24_OFF = 0x2C
...
_CONTROL_FIELDS = {
    ...
    "control_period_iep_ticks": (0x24, "I"),
}
...
_PWM_OUT_FIELDS = {
    ...
    "status": (0x28, "I"),
    "speed_cmd_q24": (0x2C, "i"),
    "timestamp_iep": (0x20, "Q"),
}
